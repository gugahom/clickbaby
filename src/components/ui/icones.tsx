...
/** Duas folhas sobrepostas: copiar o link para a área de transferência. */
export function IconeCopiar({ className }: PropsIcone) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** Lixeira: apagar o link colado errado. */
export function IconeLixeira({ className }: PropsIcone) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** Megafone: o AVISO da etapa — anúncio para quem vem, não alarme de tempo. */
...
/** Relógio: hora marcada chegando ou estourada — ver o sino. */
